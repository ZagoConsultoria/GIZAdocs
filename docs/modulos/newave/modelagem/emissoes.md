...
| Tema                         | Geração de esqueleto de relatório Word                                                                                                                                             |
| Descrição                    | Eu, como analista ambiental, desejo gerar um documento Word com o esqueleto do relatório e tabelas pré-preenchidas para facilitar a finalização com dados de partículas e imagens. |
| Critérios de Aceitação       | - O Word deve ser gerado com tabelas formatadas.<br>- Os campos restantes devem estar sinalizados para edição posterior.<br>- O layout deve seguir o padrão da empresa.            |
| Prioridade Usuário           | Média                                                                                                                                                                              |
| Status                       | Validada                                                                                                                                                                           |
